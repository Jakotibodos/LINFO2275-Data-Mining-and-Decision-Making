...
class Tetris:
    ...
    def reset(self):
        ...
        self.cleared_lines_distribution = {1:0,2:0,3:0,4:0} #ADDED BY JAKOB
    ...
    def render(self, video=None):
        ...
        #ADDED BY JAKOB
        cv2.putText(img, "Clears", (self.width * self.block_size + int(self.block_size / 2), 10 * self.block_size),
                    fontFace=cv2.FONT_HERSHEY_DUPLEX, fontScale=1.0, color=self.text_color)
        cv2.putText(img, "1 line: "+str(self.cleared_lines_distribution[1]),
                    (self.width * self.block_size + int(self.block_size / 2), 11 * self.block_size),
                    fontFace=cv2.FONT_HERSHEY_DUPLEX, fontScale=0.8, color=self.text_color)
        cv2.putText(img, "2 line: "+str(self.cleared_lines_distribution[2]),
                    (self.width * self.block_size + int(self.block_size / 2), 12 * self.block_size),
                    fontFace=cv2.FONT_HERSHEY_DUPLEX, fontScale=0.8, color=self.text_color)
        cv2.putText(img, "3 lines: "+str(self.cleared_lines_distribution[3]),
                    (self.width * self.block_size + int(self.block_size / 2), 13 * self.block_size),
                    fontFace=cv2.FONT_HERSHEY_DUPLEX, fontScale=0.8, color=self.text_color)
        cv2.putText(img, "4 lines: "+str(self.cleared_lines_distribution[4]),
